...
from drlvis.data_preprocessor import DataPreprocessor
...
def main():
    ...
    thread_flask = Thread(target=run_flask_server(args))
    thread_flask.start()


def run_http_server():
    this_dir, _ = os.path.split(__file__)
    os.system("cd "+this_dir+"/dist ; python3 -m http.server 8000")
